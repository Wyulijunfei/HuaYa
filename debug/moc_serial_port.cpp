...
QT_MOC_LITERAL(1, 12, 8), // "return_b"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 27), // "on_OpenSerialButton_clicked"
QT_MOC_LITERAL(4, 50, 21), // "on_SendButton_clicked"
QT_MOC_LITERAL(5, 72, 17) // "slotReadSerialMsg"

    },
    "serial_port\0return_b\0\0on_OpenSerialButton_clicked\0"
    "on_SendButton_clicked\0slotReadSerialMsg"
};
...
void serial_port::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->return_b(); break;
        case 1: _t->on_OpenSerialButton_clicked(); break;
        case 2: _t->on_SendButton_clicked(); break;
        case 3: _t->slotReadSerialMsg(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (serial_port::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&serial_port::return_b)) {
                *result = 0;
                return;
            }
        }
